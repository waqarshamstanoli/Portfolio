                ...
                <v-col cols="12" lg="4" md="12" sm="12" >
                    ...
                    <v-form method="POST" action="https://formspree.io/f/xeqydqrl" v-model="valid"
                        ...
                        <v-container>
                            <v-row>
                                <v-col cols="12" md="10">
                                    <v-text-field outlined tile dense v-model="formData.name" :counter="10" name="Name"
                                        :rules="nameRules" label="Name" hide-details required></v-text-field>
                                </v-col>
                                <v-col cols="12" md="10">
                                    <v-text-field outlined tile dense v-model="formData.email" :rules="emailRules"
                                        name="Email" label="E-mail" hide-details required></v-text-field>
                                </v-col>
                                <v-col cols="12" md="10" >
                                    <v-btn tile type="submit" :disabled="!valid" color="primary">Submit</v-btn>
                                </v-col>
                            </v-row>
                        </v-container>
                    </v-form>
                            ...
                            <v-list color="transparent" dense>
                                ...
                                <v-list-item two-line class="btnText--text  text-body-2 pl-0">
                                    ...
                                    <v-list-item-content class="pt-0">
                                        <a href="https://wa.me/3458112216">
                                            <v-list-item-title>
                                                <a href="https://wa.me/3458112216" class=" btnText--text"> Whatsapp
                                                </a>
                                            </v-list-item-title>
                                            <v-list-item-subtitle class="btnText--text">
                                ...
                                <v-list-item two-line class="btnText--text  text-body-2 pl-0">
                                    <v-list-item-content class="pt-0">
                                        <v-list-item-title>
                                            <a href="mailto:waqar.shamstanoli@gmail.com" class=" btnText--text">
                ...
                <v-col cols="12" lg="4" md="12" sm="12" >
                    <div :class="{ 'mt-0': !$vuetify.breakpoint.mdAndUp, 'social-links': $vuetify.breakpoint.mdAndUp }"
                        ...
                        <a v-else href="https://www.facebook.com/BimmerTechLLP/">
                            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" class="ml-4"
                                xmlns="http://www.w3.org/2000/svg">
                        ...
                        <svg v-else width="44" height="44" viewBox="0 0 44 44" fill="none" class="ml-4"
                            xmlns="http://www.w3.org/2000/svg">
                            <rect x="0.5" y="0.5" width="43" height="43" rx="21.5" stroke="black" />
                            <path
                                d="M30.8008 17.6445C31.2227 19.1211 31.2227 22.2852 31.2227 22.2852C31.2227 22.2852 31.2227 25.4141 30.8008 26.9258C30.5898 27.7695 29.9219 28.4023 29.1133 28.6133C27.6016 29 21.625 29 21.625 29C21.625 29 15.6133 29 14.1016 28.6133C13.293 28.4023 12.625 27.7695 12.4141 26.9258C11.9922 25.4141 11.9922 22.2852 11.9922 22.2852C11.9922 22.2852 11.9922 19.1211 12.4141 17.6445C12.625 16.8008 13.293 16.1328 14.1016 15.9219C15.6133 15.5 21.625 15.5 21.625 15.5C21.625 15.5 27.6016 15.5 29.1133 15.9219C29.9219 16.1328 30.5898 16.8008 30.8008 17.6445ZM19.6562 25.1328L24.6484 22.2852L19.6562 19.4375V25.1328Z"
