    ...
    <v-container fluid class="pa-md-8 pa-4">
      <v-row>
        <v-col cols="12" lg="4" md="12" sm="12">
          <v-form method="POST" action="https://formspree.io/f/xeqydqrl" v-model="valid" @submit.prevent="submitForm" class="pa-5" style="border: 1px solid white; border-radius: 20px">
            <v-container>
              <v-row>
                <v-col cols="12" md="10">
                  <v-text-field outlined tile dense v-model="formData.name" :counter="10" name="Name" :rules="nameRules" :label="$t('name')"  hide-details required></v-text-field>
                </v-col>
                <v-col cols="12" md="10">
                  <v-text-field outlined tile dense v-model="formData.email" :rules="emailRules" name="Email" :label="$t('email')" hide-details required></v-text-field>
                </v-col>
                <v-col cols="12" md="10">
                  <v-btn tile type="submit" :disabled="!valid" color="primary">{{$t("submit")}}</v-btn>
                </v-col>
              </v-row>
            </v-container>
          </v-form>
        ...
        <v-col cols="12" lg="8" md="12" sm="12">
          <v-row>
            <v-col cols="12" lg="4" md="3" sm="6" class="pb-0" :class="{ '': !$vuetify.breakpoint.smAndDown, custom: $vuetify.breakpoint.smAndDown }">
              <h4 class="white--text btnText--text">{{ $t("services") }}</h4>
              <v-list color="transparent" dense>
                <v-list-item link v-for="(item, index) in company" :key="index" :to="item.link" class="white--text btnText--text text-body-2 pl-0 pr-0">
                  {{ $t(item.title) }}
                </v-list-item>
              </v-list>
            </v-col>
            <v-col cols="12" lg="4" md="3" sm="6" class="pb-0" order-lg="2" :class="{ '': !$vuetify.breakpoint.smAndDown, custom: $vuetify.breakpoint.smAndDown }">
              <h4 class="white--text btnText--text">{{ $t("have_questions") }}</h4>
              <v-list color="transparent" dense>
                <v-list-item two-line class="grey--text text--lighten-5 text-body-2 pl-0 pr-0">
                  ...
                  <v-list-item-content>
                    <v-list-item-title>
                      <a href="tel:+923458112216" class="btnText--text">+92 923458112216 </a>
                    </v-list-item-title>
                    <v-list-item-subtitle class="btnText--text"> (9:00am - 5:00pm PKT) </v-list-item-subtitle>
                  </v-list-item-content>
                </v-list-item>
                <v-list-item two-line class="btnText--text text-body-2 pl-0">
                  ...
                  <v-list-item-content class="pt-0">
                    <a href="https://wa.me/3458112216">
                      <v-list-item-title>
                        <a href="https://wa.me/3458112216" class="btnText--text"> Whatsapp </a>
                      </v-list-item-title>
                      <v-list-item-subtitle class="btnText--text"> Worldwide chat with us </v-list-item-subtitle>
                    </a>
                  </v-list-item-content>
                </v-list-item>
                <v-list-item two-line class="btnText--text text-body-2 pl-0">
            ...
            <v-col cols="12" lg="4" md="3" sm="6" class="pb-0" order-lg="1" :class="{ '': !$vuetify.breakpoint.smAndDown, custom: $vuetify.breakpoint.smAndDown }">
              <h4 class="white--text btnText--text">{{ $t("industries") }}</h4>
              <v-list color="transparent" dense>
                <v-list-item link v-for="(item, index) in policies" :key="index" :to="item.link" class="btnText--text text-body-2 pl-0 pr-0">
                    {{ $t(item.title)}}
                </v-list-item>
              </v-list>
            </v-col>
          ...
          <div :class="{ 'mt-0': !$vuetify.breakpoint.mdAndUp, 'social-links': $vuetify.breakpoint.mdAndUp }" style="display: flex; gap: 10px">
            ...
            <a v-else href="https://www.facebook.com/BimmerTechLLP/">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none" class="ml-4" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M25.8086 23.375H23.1719V31.25H19.6562V23.375H16.7734V20.1406H19.6562V17.6445C19.6562 14.832 21.3438 13.25 23.9102 13.25C25.1406 13.25 26.4414 13.4961 26.4414 13.4961V16.2734H25C23.5938 16.2734 23.1719 17.1172 23.1719 18.0312V20.1406H26.3008L25.8086 23.375Z" fill="black" />
              </svg>
            </a>
            ...
            <a v-else href="https://www.linkedin.com/company/madinatech-innovations/about/?viewAsMember=true">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none" class="ml-4" xmlns="http://www.w3.org/2000/svg">
                <rect x="0.5" y="0.5" width="43" height="43" rx="21.5" stroke="black" />
                <path d="M17.5156 29H14.2461V18.4883H17.5156V29ZM15.8633 17.082C14.8438 17.082 14 16.2031 14 15.1484C14 13.707 15.5469 12.793 16.8125 13.5312C17.4102 13.8477 17.7617 14.4805 17.7617 15.1484C17.7617 16.2031 16.918 17.082 15.8633 17.082ZM29.7148 29H26.4805V23.9023C26.4805 22.6719 26.4453 21.125 24.7578 21.125C23.0703 21.125 22.8242 22.4258 22.8242 23.7969V29H19.5547V18.4883H22.6836V19.9297H22.7188C23.1758 19.1211 24.2305 18.2422 25.8125 18.2422C29.1172 18.2422 29.75 20.4219 29.75 23.2344V29H29.7148Z" fill="black" />
              </svg>
            </a>
